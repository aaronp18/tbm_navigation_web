        ...
        <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          <group position={[0, -1, 0]} rotation={[Math.PI / 2, 0, 0]}>
            <group position={[0, 0, -1]} rotation={[-Math.PI / 2, 0, 0]}>
              <group position={[0, -1, 0]} rotation={[Math.PI / 2, Math.PI / 2, 0]} />
              <group position={[0, -1, 0]} rotation={[Math.PI / 2, Math.PI / 2, 0]} />
            </group>
          </group>
          ...
          <group position={[0, -2, 0]} rotation={[Math.PI / 2, 0, 0]}>
            <group position={[-9.93, -13.35, 25.47]}>
              <group position={[9.93, 13.35, -25.47]} rotation={[0, 1.57, 0]}>
            ...
            <mesh geometry={nodes.mesh_20.geometry} material={materials['Stainless Steel - Polished']} />
          ...
          <group position={[24.5, 0, 0]} rotation={[-Math.PI / 2, 0, Math.PI]}>
            <mesh geometry={nodes.mesh_30.geometry} material={materials['Aluminum - Polished']} />
          </group>
